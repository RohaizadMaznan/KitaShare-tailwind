        ...
        >
          ...
          <ul className="list-reset lg:flex justify-end items-center">
            <li className="mr-3 py-2 lg:py-0">
              <Link
                className={`inline-block py-2 px-3 text-gray-900 no-underline transition duration-150 ease-in-out hover:bg-gray-200 rounded-md ${
                  currentRoute.includes("documentation") ? "font-bold bg-gray-200" : " "
                }`}
            ...
            <li className="mr-3 py-2 lg:py-0">
              <Link
                className={`inline-block py-2 px-3 text-gray-900 no-underline transition duration-150 ease-in-out hover:bg-gray-200 rounded-md ${
                  currentRoute.includes("discussion") ? "font-bold bg-gray-200" : " "
                }`}
                to="/discussion/home"
              >
                Discussion
            ...
            <li className="mr-3 py-2 lg:py-0">
              ...
              >
                ...
                <svg
                  className="w-5 h-5 text-white flex-shrink-0 ml-2 -mr-1"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
