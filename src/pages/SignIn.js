          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                <h1 className="h1" data-aos="zoom-y-out">Welcome back. We exist to make entrepreneurism easier.</h1>
              </div>
              ...
              <div className="max-w-sm mx-auto">
                <form data-aos="zoom-y-out" data-aos-delay="150">
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      <label className="block text-gray-800 text-sm font-medium mb-1" htmlFor="email" data-aos="zoom-y-out">Email</label>
                ...
                <form>
                  ...
                  <div className="flex flex-wrap -mx-3" data-aos="zoom-y-out" data-aos-delay="350">
                    <div className="w-full px-3">
                ...
                <div className="text-gray-600 text-center mt-6" data-aos="zoom-y-out" data-aos-delay="450">
